...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="ProfessorController?action=listarProfessor"><span>Biblioteca</span>IMPACTA</a>
				<ul class="user-menu">
    ...
    <tbody>
     <c:forEach items="${livro}" var="livro">
      <tr>
     <td><c:out value="${livro.idLivro}" /></td>
                    <td><c:out value="${livro.nomeLivro}" /></td>
                    <td><c:out value="${livro.anoLivro}" /></td>
                    <td><c:out value="${livro.autorLivro}" /></td>
                                 
                    <td><a href="LivroController?action=edit&livroId=<c:out value="${livro.idLivro }"/>">Alterar</a></td>
                    <td><a
                        href="LivroController?action=delete&livroId=<c:out value="${livro.idLivro }"/>">Excluir</a></td>
                </tr>
