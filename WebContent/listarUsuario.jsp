...
<body>
    ...
    <tbody>
     ...
     <td><c:out value="${usuario.idUsuario}" /></td>
                    ...
                    <td><a
                        href="UsuarioController?action=edit&idUsuario=<c:out value="${usuario.idUsuario }"/>">Alterar</a></td>
                    <td><a
                        href="UsuarioController?action=delete&idUsuario=<c:out value="${usuario.idUsuario }"/>">Excluir</a></td>
                </tr>
