        ...
        <fieldset>
            <div>
                 ...
                 <input class="form-control" type="text"
                    name="livroId" value="<c:out value="${livro.idLivro}" />"
                    readonly="readonly" placeholder="Id Professor..." style="visibility: hidden;"/>
            </div>
            <div>
                <label for="nomeLivro">Nome do Livro</label> 
                <input class="form-control" type="text"
                    name="nomeLivro" value="<c:out value="${livro.nomeLivro}" />"
                    placeholder="Digite o nome do livro..." />
            </div>
            <div>
                <label for="anoLivro">Ano Livro</label> 
                <input class="form-control" type="text" maxlength="4"
                    name="anoLivro" value="<c:out value="${livro.anoLivro}" />"
                    placeholder="Digite o ano do livro..." />
            </div>
            <div>
                <label for="autorLivro">Autor</label> 
                <input class="form-control" type="text" name="autorLivro" 
                    value="<c:out value="${livro.autorLivro}" />" placeholder="Digite o autor do livro..." />
            </div>
  
            <br>	
            <div>
                <input class="btn btn-primary" style="width:100%" type="submit" value="Cadastrar Livro" />
            </div>
        </fieldset>
    </form>
					</div>
