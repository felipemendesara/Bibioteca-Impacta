...
<body>
    ...
    <tbody>
     <c:forEach items="${aluno}" var="aluno">
      <tr>
     <td><c:out value="${aluno.alunoId}" /></td>
                    <td><c:out value="${aluno.nomeAluno}" /></td>
                    <td><c:out value="${aluno.RA}" /></td>
                    <td><c:out value="${aluno.senha}" /></td>
                    <td><c:out value="${aluno.idade}" /> anos</td>
                    
                    <td><a
                        href="AlunoController?action=edit&alunoId=<c:out value="${aluno.alunoId }"/>">Alterar</a></td>
                    <td><a
                        href="AlunoController?action=delete&alunoId=<c:out value="${aluno.alunoId }"/>">Excluir</a></td>
                </tr>
